...
public class AccountServiceImpl implements AccountService {
	 ...
	 * function of addCoupon has some wrong
	 */
	@POST
	@Path("/addCoupon")
	@Produces({ "application/json" })
	@Override
	public void addCoupon(CouponDto couponDto,@QueryParam("account_id") int account_id) {
		Account account=accountDao.getObjectById(account_id);
	...
	public List<AssociationDto> getAssociations(@QueryParam("account_id") int account_id) {
        ...
        for(Association association:associations){
        	AssociationDto associationDto = dozerBeanUtil.convert(association, AssociationDto.class);
